...
$j(document).ready(function() {
  //console.log('loaded review code');
  $j(".sidebar-reviews-rate-number").click(function() {
    //console.log('clicked review number');
    rate = $j(this);
    ...
    $j.ajax({
      ...
      success: function(res) {
        ...
        //If vote successful
        if (res !== "already") {
          $j(".sidebar-reviews-info-nrate").text(post_rate);
          $j(".sd-header-review-rate").text(res);
          var totalVoteCount = $j("#total-vote-count");
